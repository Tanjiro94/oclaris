...
import { createDaController, listDaController, getDaByIdController, updateDaController, deleteDaController, toggleFavoriteDaController, listFavoriteDasController, addPlaceToDaController, removePlaceFromDaController, setDaStylesController, setDaConstraintsController, listGenerationJobsForDaController, listGenerationJobsForUserController } from '../modules/da/controllers/da.controller.js';
...
router.get('/da/:id/generation-jobs',requireAuth, listGenerationJobsForDaController);
